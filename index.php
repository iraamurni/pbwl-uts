...
<body>
      ...
      <aside>
            ...
            <header>
                  <img src="layouts/assets/img/logo-warung.png" class="brand">
                  <div class="user">Warung</div>
                  <div class="user">Buk Ratna</div>
            </header>
            ...
            <nav>
                  <ul>
                        ...
                        <li>
                              ...
                              <img class="icon" src="layouts/assets/img/logo-login.png" alt=""> Keluar
                              </a>
                        </li>
                  </ul>
            </nav>
