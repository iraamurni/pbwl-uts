...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Bulan Mei 2023 pada 14.10
...
(1, 'Ira Murni', '21232f297a57a5a743894a0e4a801fc3', 'admin'),
(2, 'cimun', 'admin', '21232f297a57a5a743894a0e4a801fc3');
...
(1, 'Shampo Sunsilk', '1000'),
(2, 'Shampo Dove', '1000'),
(3, 'Beras', '13000'),
(4, 'Minyak Makan', '14000'),
(5, 'Hatari', '6000'),
(6, 'Pepsodent', '5000');
...
(1, 'Ucok', '082370315500', 'Jl. Purwo'),
(2, 'Jaenab', '081262770011', 'Gg. Darma');
...
CREATE TABLE `tb_transaksi` (
  ...
  `transaksi_pemilik` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tb_transaksi` (`transaksi_id`, `transaksi_pelanggan_id`, `transaksi_tanggal`, `transaksi_pemilik`) VALUES
(1, 1, '2023-04-10', 'Ratna'),
(2, 2, '2023-04-30', 'Ratna');
...
ALTER TABLE `tb_transaksi`
  ...
  ADD KEY `transaksi_pelanggan_id` (`transaksi_pelanggan_id`);
